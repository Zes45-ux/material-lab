...
- 火药保持 `Species::Gunpowder = 20`、引信起点 `rb = 8`、压力阈值 `> 120`、爆炸 `pressure = 200`、`density = 60`、`dy = 10` 和风力阈值 30。
- 普通引信 `rb = 8..2` 检查固定八方向水格；`rb = 1` 和压力 `> 120` 不接受水灭，压力判断优先。
